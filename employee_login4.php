...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM bodega_home WHERE username = '$username' AND password = '$password'";
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: employee_login4.php?error=" . urlencode($error));
        exit();
    }
}
...
<body>
    ...
    <h2>Bodega Home Login</h2>
    <div class="container">
        <form action="employee_login4.php" method="post">
