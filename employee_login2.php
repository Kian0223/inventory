...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM garios WHERE username = '$username' AND password = '$password'";
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: employee_login2.php?error=" . urlencode($error));
        exit();
    }
}
...
<body>
    ...
    <h2>Garios Login</h2>
    <div class="container">
        <form action="employee_login2.php" method="post">
