...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM wowmoto WHERE username = '$username' AND password = '$password'";
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: employee_login3.php?error=" . urlencode($error));
        exit();
    }
}
...
<body>
    ...
    <h2>Wowmoto Login</h2>
    <div class="container">
        <form action="employee_login3.php" method="post">
