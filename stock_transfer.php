...
if (isset($_POST['transfer'])) {
    ...
    if ($existingProductResult->num_rows > 0) {
        ...
        $newK1Quantity = $existingProductData['k1'] - 1;
    
        $updateQuantity = $conn->prepare("UPDATE products SET $destination = ?, k1 = ? WHERE id = ?");
        ...
        if ($updateQuantity->affected_rows > 0) {
            ...
            header("Location: stock_transfer.php?error=Failed to add the product. Please try again.");
            exit();
        }
    } else {
        ...
        <div class="signout-container">
            <form action="stock_transfer.php" method="post">
                <div class="form-group">
                    <button type="button" onclick="window.location.href='restricted_inventory.php'">Back</button>
                </div>
